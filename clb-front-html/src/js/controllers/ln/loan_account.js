...
app.controller('LoanAccountOpenMgmtCtrl', function ($scope, $http, $filter, $timeout, $interval,dataTableUtils,formUtils) {
...
//    $scope.placeholders = shareDataService.getPlaceHolders();
    ...
    $scope.search = function () {
        ...
        var dataTablesSelector = angular.element('#tblLoanAccount');
    ...
    $scope.$watch('$viewContentLoaded', function () {
        ...
        var tblOrganizations = angular.element('#tblLoanAccount');
        ...
        var setDataTableClickable = $interval(function () {
            ...
            if (tblOrganizations.DataTable !== undefined && $.fn.dataTable.isDataTable('#tblLoanAccount')) {

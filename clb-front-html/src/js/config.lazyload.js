...
angular.module('app')
  ...
  .constant('JQ_CONFIG', {
      ...
      dataTable:      [   '../libs/jquery/datatables/media/js/jquery.dataTables.min.js',
          ...
          '../libs/jquery/datatables.net-rowreorder/js/dataTables.rowReorder.min.js',
          '../libs/jquery/datatables.net-rowreorder-bs/css/rowReorder.bootstrap.min.css',
  ...
  .constant('MODULE_CONFIG', [
      ...
      },
      {
          name: 'ivh.treeview',
          files: [
              '../libs/angular/angular-ivh-treeview/dist/ivh-treeview.min.js',
              '../libs/angular/angular-ivh-treeview/dist/ivh-treeview.min.css'
          ]
      },
      {
          name: 'ztree',
          files: [ 
        	  '../libs/jquery/ztree/js/jquery.ztree.core.js',

...
app.controller('LoanLendingMgmtCtrl', function ($scope, $http, $filter, $timeout, $interval,dataTableUtils,formUtils) {
	...
	//前端列表搜索条件（注意：查询条件需要加上param_前缀，方便后台统一处理查询条件）
	 $scope.fields = {
	        	...
	        	user: "test",
	        	correlid:"test",
	        	param_lncntrct_cntrct_status : '2',
...
//    $scope.placeholders = shareDataService.getPlaceHolders();
    ...
    $scope.search = function () {
        ...
        var dataTablesSelector = angular.element('#tblLoanLendingMgmt');
    ...
    $scope.$watch('$viewContentLoaded', function () {
        ...
        var tblOrganizations = angular.element('#tblLoanLendingMgmt');
        ...
        var setDataTableClickable = $interval(function () {
            ...
            if (tblOrganizations.DataTable !== undefined && $.fn.dataTable.isDataTable('#tblLoanLendingMgmt')) {

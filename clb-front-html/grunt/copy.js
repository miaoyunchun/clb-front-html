        ...
        files:[
            ...
            },
            {
                src:  [
                    ...
                    'datatables.net-buttons/js/*.min.js',
                    ...
                    'datatables.net-rowreorder-bs/css/rowReorder.bootstrap.min.css',
            ...
            {src: '**', cwd: 'libs', dest: 'src/libs', expand: true}
        ]
    },
    angular: {
        files: [
            {expand: true, src: ['**', '!**/less/**', '!**/*.es6', '!**/*.map'], cwd: 'src/',   dest: "angular/"}
        ]
    },
    html: {
        files: [
